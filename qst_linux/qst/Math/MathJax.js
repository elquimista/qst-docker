        ...
        MathJax.Hub = {
            ...
            setRenderer: function(d, c) {
                ...
                if (!MathJax.OutputJax[d]) {
                    ...
                    var b = "Math/jax/output/" + d + "/config.js";
            ...
            formatError: function(b, f) {
                ...
                if (MathJax.Extension.MathEvents) {
                    var d = MathJax.Extension.MathEvents.Event;
                    c.oncontextmenu = d.Menu;
                    c.onmousedown = d.Mousedown;
                    c.onkeydown = d.Keydown;
                    c.tabIndex = 0
                } else {
                    MathJax.Ajax.Require("Math/extensions/MathEvents.js", function() {
                        var i = MathJax.Extension.MathEvents.Event;
                        c.oncontextmenu = i.Menu;
                        c.onmousedown = i.Mousedown;
                        c.keydown = i.Keydown;
                        c.tabIndex = 0
                    })
                }
            ...
            MenuZoom: function() {
                if (MathJax.Hub.config.showMathMenu) {
                    if (!MathJax.Extension.MathMenu) {
                        setTimeout(function() {
                            MathJax.Callback.Queue(["Require", MathJax.Ajax, "Math/extensions/MathMenu.js", {}], ["loadDomain", MathJax.Localization, "MathMenu"])
                        }, 1000)
                    } else {
                        setTimeout(MathJax.Callback(["loadDomain", MathJax.Localization, "MathMenu"]), 1000)
                    }
                    if (!MathJax.Extension.MathZoom) {
                        setTimeout(MathJax.Callback(["Require", MathJax.Ajax, "Math/extensions/MathZoom.js", {}]), 2000)
                    }
                }
            },
            onLoad: function() {
